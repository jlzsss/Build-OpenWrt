...
git clone --depth 1 --filter=blob:none --sparse https://github.com/coolsnowwolf/lede.git temp-lede && cd temp-lede && git sparse-checkout set pcre && cd .. && mv temp-lede/package/libs/pcre package && rm -rf temp-lede
